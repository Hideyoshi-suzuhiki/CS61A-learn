...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    ans = 3 * abs(opponent_score % 100 // 10 - player_score % 10)
    if(ans):
        return ans
    else:
        return 1
...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    res = simple_update(num_rolls, player_score, opponent_score, dice)
    res = sus_points(res)
    return res
    # END PROBLEM 4
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    num = roll_dice(6,six_sided)
    return boar_strategy(score, opponent_score, num, num_rolls=6) # Remove this line once implemented.
    # END PROBLEM 12
